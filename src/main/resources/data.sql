...
VALUES ('김진호', 27, '010-1234-1234', '2000-08-29', '06EA3L');

INSERT INTO member (name, age, phone, birth, card_uid)
VALUES ('이준호', 28, '010-1234-1234', '1999-09-30', '06EA4L');

INSERT INTO member (name, age, phone, birth, card_uid)
VALUES ('박정호', 29, '010-1234-1234', '1998-10-29', '1BQ274');
...
---- password: userpass
--INSERT INTO authentications (username, password, authority, displayname)
--VALUES ('user', '$2a$10$BE6pXn.93R5XfYqrTmDyxuZhvflnKwVbLtVkmSSjXpFdOBoquFAVq', 'USER', '일반사용자');