...
| FIN-008 | 마감 시각에 서버 중지 후 재기동 | 시작 시 DB에서 모든 마감 시각 경과·미마감 날짜를 찾아 즉시 동적 예약 |
...
| FIN-013 | 최초 마감과 이후 retry가 계속 실패 | 실패 시각부터 1·2·4·8·16분에 정확히 다섯 번 재시도, 이후 `SCHEDULED` 마감 지연으로 유지 |
