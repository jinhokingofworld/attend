...
| Migration | 빈 DB·레거시 fixture·복원 DB | V001~V010, baseline 0, 권한, 재현성 | 별도 PostgreSQL |
...
| ID | 환경·작업 | 합격 기준 |
|---|---|---|
| MIG-FRESH-001 | 완전히 빈 DB에 V001~V010 적용 | baseline 행 없이 전체 목표 schema 생성 |
...
| MIG-RUNTIME-001 | 성공한 versioned history가 V001~V010과 정확히 일치 | runtime 기동 허용 |
| MIG-RUNTIME-002 | history 없음·실패 행·version 누락·V010 미만·승인 target 초과 각각 | runtime이 쓰기 받기 전에 fail fast |
